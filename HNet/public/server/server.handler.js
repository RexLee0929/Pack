(()=>{
    ...
    function l(i) {
        ...
        c.location = v.location.emulate((e=>"about:srcdoc" === e ? new URL(e) : (e.startsWith("blob:") && (e = e.slice("blob:".length)),
        ...
        const L = w && Object.getOwnPropertyDescriptor(w.prototype, "contentWindow").get;
        function E(e) {
            const t = L.call(e);
            if (!t.__uv)
                try {
        ...
        v.url.on("createObjectURL", (e=>{
            ...
            if (t.startsWith("blob:" + location.origin)) {
                let a = "blob:" + ("about:blank" !== c.meta.url.href ? c.meta.url.origin : i.parent.__uv.meta.url.origin) + t.slice("blob:".length + location.origin.length);
                c.blobUrls.set(a, t),
                e.respondWith(a)
            } else
                e.respondWith(t)
        ...
        v.storage.on("clear", (e=>{
            if (e.that.__uv$storageObj)
                for (const t of v.nativeMethods.keys.call(null, e.that.__uv$storageObj))
